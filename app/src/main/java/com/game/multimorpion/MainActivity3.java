...
import com.google.firebase.database.ValueEventListener;import androidx.appcompat.app.AlertDialog;
import androidx.appcompat.app.AppCompatActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (soloPlayer)
                    intent.putExtra("_soloPlayer", true);
                else
                    intent.putExtra("_soloPlayer", false);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!gameOver) {
                    if (snapshot.getValue(String.class).contains("EXIT") && role.equals("O")) {
                        ...
                        MainActivity3.this.finish();
                        Toast.makeText(MainActivity3.this, "YOU LOSE FROM LEAVING !", Toast.LENGTH_SHORT).show();
                    }
